...
export const meta_data = {
    home: () => {
        const title = 'Home';
        const description = 'c squared\'s Solutions to Hatcher\'s Algebraic Topology';
        const keywords = '';
    ...
    exercise: (exercise_id) => {
        ...
        const description = `c squared\'s solution to Exercise ${exercise_id} of Hatcher\'s Algebraic Topology`;
        const keywords = '';
        return { title, description, keywords };
    },
    error: () => {
